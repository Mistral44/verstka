...
(function($){
	...
	$.fn.dsCountDown = function(givenOptions){
		...
		var defaults = {
			...
			titleDays: 'дн.',			// Set the title of days
			titleHours: 'час.',		// Set the title of hours
			titleMinutes: 'мин.',	// Set the title of minutes
			titleSeconds: 'сек.',	// Set the title of seconds
...
$('.event-time__countdown').dsCountDown({
	endDate: new Date("March 20, 2020 23:59:59")
});